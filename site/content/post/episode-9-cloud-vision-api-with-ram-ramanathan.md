...
{{< transcript "﻿CAMPOY: Hi, and welcome to the ninth episode of the Google Cloud Platform podcast. I am Francesc Campoy, and I'm here with my co-host Mark Mandel. Hey, Mark." >}}
MANDEL: Hey, Francesc. How you doing today?
CAMPOY: Pretty good. Happy New Year.
MANDEL: Happy New Year to you too. Good start of the year, brand new podcast episode.
CAMPOY: Yeah, finally, finally. Took a couple weeks extra, but I'm finally back to the United States, and I'm actually very excited about this episode.
MANDEL: Yeah, it's gonna be a good one. I'm pretty happy about it.
CAMPOY: Yup. Before we even talk about what the main content's gonna be, let's start with the cool thing of the week.
MANDEL: The cool thing of the week I like a lot. I'm definitely a big fan of the command line, being--especially being a Linux user as well, and I really like the blog post we're seeing today of the top five power features of the Google Cloud CLI. 
CAMPOY: Yeah.
MANDEL: There were some tricks in here that I didn't know about that I thought were particularly impressive.
CAMPOY: Yeah, especially if you are a command line person and especially if you know how to use awk and sort and all of these little tools that you can use very well, you can find out really cool stuff quite easily.
MANDEL: The nice thing is, is actually, there's stuff in the Google Cloud command line interface that don’t require you to use, like, set or awk. You can actually tell it to format stuff in, like, CSV or JSON just through the command line options.
CAMPOY: Oh, that's very nice.
MANDEL: And you can push it to, like, all sorts of different things. It's really impressive. I've been a longtime user of the code completions that you can get through Zsh and Bash, but--
CAMPOY: Yeah, actually, you got me hooked on Zsh, and that’s how I discovered the code completion, and--the code completion, sorry, the auto-completion. The impressive thing about it, about the auto-completion, is that it auto-completes about--on many things.
MANDEL: Yes.
CAMPOY: Not only the commands themself but also, like, instance names and--
MANDEL: And, like, zones and--
CAMPOY: Zone and regions, which is great 'cause I never remember how to write bridges. I never remember where the dash goes, so yeah.
MANDEL: Yeah, or what was my compute instance name or, like, stuff like that.
CAMPOY: Yeah, yeah, yeah.
MANDEL: It's like, "What is that?" I have one I'm gonna add to the list. This isn't mine. This is a coworker's of ours, Sandeep. He came up with a nice way of--and this does use awk, but we'll put it in the show notes, that literally lets you pull out what your project name is from your config file. I've found that particularly useful when writing, like, Bash scripts and make files where that project detail has to be sort of in that as an argument for certain things.
CAMPOY: Yeah, that's very nice. Actu--I could definitely see that as part of some deployment script or some build part, yeah. That sounds really interesting.
MANDEL: Yeah, no, well, we're commonly building, you know, examples and stuff where they have to work on either our project or somebody else's so we can't just hard code a project ID.
CAMPOY: Yup. Yeah, I've done that--I've hard coded many project IDs many times, and then when you want to open source it, you're like, "Oh, yeah."
MANDEL: So you're working on your staging project, and then you're putting it in your prod project, and then you're like, "Oh, man, now I have to, like, do this." Yeah, it's bad.
CAMPOY: Yeah, no, definitely--definitely useful. We'll add that little command on top on the show notes on--in addition to ar--the link to this article. Okay, so that was our first cool thing of the year--cool thing of the--actually, yeah, cool thing of year.
MANDEL: That was our first cool thing of the year.
CAMPOY: Cool thing of the year, there you go. And now we're gonna pass to this amazing interview.
MANDEL: Yeah.
CAMPOY: I personally had lots of fun doing it.
MANDEL: It was really interesting.
CAMPOY: Yeah, I think that Ram is a very interesting guy and knows a lot about many things, and we're actually going to be talking about one of the coolest APIs that I think we have.
MANDEL: Cloud Vision API, very exciting stuff.
CAMPOY: Exactly. So I say we just go for it.
MANDEL: Sounds good. We are joined today by a very special guest. I'm very excited to have him here with us today. It is Ram Ramanathan. He is the product manager for Google Cloud Vision API. Thank you so much for joining us, Ram.
RAMANATHAN: Thank you guys. Thanks for having me on the show.
MANDEL: An absolute pleasure, and I did manage to pronounce your name correctly?
RAMANATHAN: Yes, you did.
MANDEL: Wonderful. I like getting that right. It makes me happy. So for those people who aren't familiar with you and what you do, do you want to give us a little bit of your background and tell us a little about yourself?
...
MANDEL: Pretty cool. So you've got a long history of sort of doing machine learning-type stuff?
...
CAMPOY: Nice. Could you give us a little bit of a general idea of--so we have machine learning and business intelligence and so on, and then on top of that there's Cloud Vision API. What is it, and how is it related to machine learning?
...
CAMPOY: That is very cool, actually. So--because that's actually--so is that the same models are powering the Safe Search option on Google Search?
...
CAMPOY: That's really awesome. I can see a lot of people working--that need, actually, that API, and the fact that they can use it out of the box just like, is this adult content or not, like, with a simple REST API, that's really cool.
RAMANATHAN: Yeah.
MANDEL: That's really, really cool. No, that's really cool, and you talked a little sort of about face detection. I did happen to see--or we got a nice demo the other day from Caz, one of our teammates, who helped work on the Cloud Vision bot, which is a cute little bot that when--it detects your face, and if you smile at it, it heads toward you, and if you frown at it, it runs away from you, which I thought was really, really cool.
RAMANATHAN: That's right.
CAMPOY: It's really cool. I try with it, but for some reason, even though I was smiling it was just ignoring me. Then we saw that the problem was that there was no WiFi, but.
MANDEL: Sure, sure, you just don't have a recognizable face, quite clearly.
CAMPOY: Yeah, I'm just not attractive enough for bots.
MANDEL: No, that's totally fair enough. Talking about face detection now, I can see here that facial recognition isn't supported. Do we want to talk a little bit about that?
...
MANDEL: That sounds pretty reasonable.
CAMPOY: That's very interesting. So basically, we're able to see what--if there's any face, what are they doing, but we don't know who they are, basically?
RAMANATHAN: That's correct.
CAMPOY: Okay.
RAMANATHAN: Exactly.
MANDEL: That seems pretty fair. 
CAMPOY: Yup.
MANDEL: That seems pretty fair. No, that sounds really good. So--okay, so I'm actually quite curious. You've probably got a bit more visibility than we do on this. Like, what sort of things are people doing with this? Like, what do you envisage people? Like, I'm sure you've got some ideas. I mean, this seems like just one of these crazy things you could do so much with.
...
MANDEL: Yeah, that sounds pretty good.
...
CAMPOY: That's very cool.
MANDEL: That is very cool.
CAMPOY: Cool, so could you tell us a little bit more about what other products use TensorFlow at Google?
...
MANDEL: Wow.
CAMPOY: Cool. Something really interesting that you mentioned is that TensorFlow is powering speech recognition, and I know that speech recognition is a very hard thing to do. Like, I'm always impressed that my phone understands me.
MANDEL: Yeah.
CAMPOY: Like, with my accent that's a very, very good job.
MANDEL: Well, actually, it's impressive that it understands you and it understands me and it understands everyone else as well, like, with all our accents.
CAMPOY: Yeah, that's really interesting, but the interesting thing is that it doesn't necessarily run through an API, right? Like, it actually runs on your phone.
RAMANATHAN: That's right.
CAMPOY: So could you just--could you tell us a little bit about how do we even do that? Like, the fact that there's so much information about a model--the model but still fits on your phone.
...
CAMPOY: Okay, so my next question then is since the robot doesn't--didn't recognize my smile 'cause the WiFi was down, could it be possible to have Google Cloud Vision API as not an API but something that you can install it, or is the model way too big?
...
CAMPOY: That's really, really cool.
MANDEL: I'm just looking at that now. I didn't even realize that exists. That's really cool.
CAMPOY: That's the good thing about this podcast.
RAMANATHAN: Yeah, it's just on developers.google.com/vision.
CAMPOY: Cool. Yeah, we'll add links to that on the show notes. Yeah, I was saying that's the good thing about this podcast, is every single episode I learn new stuff.
MANDEL: I learn new stuff, yeah, exactly. No, that's really fun. All right, wonderful. So I guess is there anything about, like, Vision API or TensorFlow or machine learning that you wanted to talk about that we haven't really sort of covered yet?
...
MANDEL: Sort of bring it down to the consumer level so it becomes easy to use.
CAMPOY: Yeah.
MANDEL: Yeah. I know I've looked at machine learning just in passing every so often, and every time I do, I'm like, "Oh, this is scary."
CAMPOY: Yeah, there's a--there's a very good course on--
MANDEL: Coursera.
CAMPOY: Coursera.
RAMANATHAN: Yeah.
MANDEL: Yeah, I've done that, bits of that.
CAMPOY: I tried to go through it. It's pretty--it gets pretty intense really fast.
MANDEL: It's really good though.
...
MANDEL: Yeah, just make it sort of, "I can plug in, take advantage, and just use and be on my way."
CAMPOY: Yeah, that's a great thing about Cloud Vision API, is that yes, machine learning is complicated, and yes, you may need to understand a lot of stuff to train a model correctly, but hey, if you know how to do cURL and use a REST API, you're good.
MANDEL: You're good to go.
CAMPOY: Yup, you're good to go, and you're gonna have it. So that's really awesome.
MANDEL: Brilliant. All right, well, thank you so much, Ram, for joining us. We really, really appreciate it. This was a really fun interview.
RAMANATHAN: Thank you--thanks for having me. [inaudible] thanks for having me, guys.
MANDEL: All right.
CAMPOY: Thank you.
MANDEL: Thank you. Thank you very much for joining us, Ram. That was a really interesting interview. I know I learnt a whole lot during that. That was great.
CAMPOY: Yeah, that was awesome. I got really excited about many other projects that I think we could build on top of that API.
MANDEL: Yeah, yeah, what--yeah. As is always with this podcast, I end up listening to someone and I'm like, "Oh, man, I got to go play with that thing. It sounds great." But yeah, enough time in the day.
CAMPOY: So--okay, so before we end this amazing episode, let's go with the question of the week.
MANDEL: Yeah, so you brought up an interesting one which I hadn't really encountered before, which was if you have a file within Google Cloud Storage but you want to provide temporary access to it, so it's not just public to the Internet. You're like, "I want it to be available for, like, an hour," or something like that, how do you go about doing that?
CAMPOY: Yeah, so there's actually one way of doing it which is the normal way, and I've seen people trying to do it. It's kind of not very useful to do, which is you actually add one email to the ACL, to the ACL, the access control list, and then after a while you remove it.
MANDEL: Okay, feels manual.
CAMPOY: That kind of works. I mean, you can do it with a script. There's a recipe as for that, so that kind of works, and you have the limit of there's only that person that will be able to access that file during the period of time that you want.
MANDEL: Okay. So that's, like, when you want, like, a specific user to be able to grab it.
CAMPOY: Yeah. Problem with that, the user needs to log in to do it.
MANDEL: Okay, got it.
CAMPOY: So depending on what you're trying to do, depending the kind of app you're developing, might be a little bit hard, so not always the perfect solution. Then we have a second solution, which is the one that I wanted to talk about today, which is what we call the signed URLs.
MANDEL: Yup.
CAMPOY: So the signed URLs, it's just an URL that is a way of accessing that resource that is only valid for some period of time.
MANDEL: Okay, so it's totally public but you can only access it for, like, an hour or a day or a week.
CAMPOY: Exactly. So you're gonna be able to say, "Okay, I'm gonna provide access to that resource, but I'm not going to make it public." Instead you're gonna--the only way to access that resource, can I go--is gonna be going through that URL, and after whatever time you choose, one hour, one minute, whatever you want, it will just disappear.
MANDEL: Okay, so that could be really good for, like, access tokens or something like that, something you want to keep--
CAMPOY: Yeah, I've personally used it for Google Cloud Spin, so that cool demo. We had one thing that we wanted to do--is when someone jumps and we have this image that is--
MANDEL: Oh, I see.
CAMPOY: Yeah, we need to visualize it.
MANDEL: Yup.
CAMPOY: And we don't want those images to be public, and we visualize the image for, like, five seconds, so what we did was to provide a signed URL that could be valid for, like, 30 seconds.
MANDEL: Oh, okay.
CAMPOY: Then the visualizer is able to show it, and if anyone was able to find--hack somehow--
MANDEL: Somehow find how to get it, yeah.
CAMPOY: Find the URL, if it's after 30 seconds, sorry, too late.
MANDEL: That's really interesting.
CAMPOY: Yup.
MANDEL: Okay. That's a really interesting one.
CAMPOY: Very useful.
MANDEL: Didn't know that existed. That's really, really cool.
CAMPOY: Yeah, and creating them, we'll add a link to the notes, but it's actually really simple. You can do it with--directly with gsutil, so the Google Cloud Storage util command, or you can also do it through REST APIs. Personally, we did it directly on App Engine, so from App Engine you can call a couple APIs, and that's it.
MANDEL: That just works. That's lovely. Okay, that's really handy to know. 
CAMPOY: Yup. So it is the end of the first episode, but before we actually say goodbye, where can I find you?
MANDEL: Okay, so I'm doing a few interesting things. I will be at the Launch Hackathon in San Francisco. After that I will be at GDC, the Game Developers Conference, also in San Francisco.
CAMPOY: Nice.
MANDEL: And then it looks like I will also be in Strata in San Jose, so I'm not really leaving California very much.
CAMPOY: Nice, you're not even leaving, like, north California, so you're really not far away.
MANDEL: No. I am going back to Australia for a bit of a holiday, but that's not work-related, so.
CAMPOY: Yeah, that's slightly more far away, yeah.
MANDEL: How about yourself?
CAMPOY: Well, so in a couple weeks I'm going to FOSDEM, so it's a really cool conference that takes place in Brussels. 
MANDEL: That's pretty good.
CAMPOY: I'm gonna be managing the Go dev room. There's gonna be a Go dev room. I'm gonna be talking there.
MANDEL: Fun.
CAMPOY: Yup, it's gonna be lots of fun. The week after that I'm going to Paris for the Google DevFest.
MANDEL: Nice.
CAMPOY: We're gonna have a bunch of developers, and if you're gonna be around, come say hi. We're gonna try to [inaudible] organize a couple hackathons or workshops. Let's see, I'm still not sure. Are we still planning that?
MANDEL: Still planning it.
CAMPOY: Yeah, but that's gonna be the first week of March.
MANDEL: We're in the same phase with, like, GDC and Strata. Stuff's gonna happen there. It'll be good. It'll be good stuff.
CAMPOY: And then--I'm actually really excited about this one, I'm going to Dubai. I'm going to Dubai for GopherCon United Emirates--or no, wait, United Arab Emirates.
MANDEL: There you go.
CAMPOY: UAE, that's it.
MANDEL: Okay.
CAMPOY: So yeah, very excited about that one too.
MANDEL: All right, wonderful. 
CAMPOY: And otherwise, if you want to contact us and you turn out not to be here in California or somewhere where I'm gonna be traveling, there's a couple ways they can contact us.
MANDEL: They can get us by email at hello@gcppodcast.com.
CAMPOY: The web page.
MANDEL: Yeah, gcppodcast.com.
CAMPOY: The Twitter.
MANDEL: Gcppodcast.
CAMPOY: The subreddit.
MANDEL: /r/gcppodcast.
CAMPOY: Good job, and on Google+?
MANDEL: +gcppodcast.
CAMPOY: And I think that's it.
MANDEL: I think that's it.
CAMPOY: Yeah.
MANDEL: If you can't reach us through one of those, then, like, I don't know how--
CAMPOY: Yeah, just let us know, but how do they let us know?
MANDEL: Yeah--no, they can't let us know.
CAMPOY: Anyway, thank you so much for being here again today. That was an awesome episode. Very excited about the rest of the year.
MANDEL: A pleasure as always, and I will see you all next week.
CAMPOY: See you next week. Bye.
{{< /transcript >}}